...
assemblyFormat = (str) => {
	...
	const instructions = /\b(ADA|ADB|ANA|ANB|SYS|CLC|CLD|CLI|CLO|CMAH|CMBH|CMPA|CMPB|CMPI|CPUID|DEA|DEB|DEI|DEJ|INA|INB|INI|INJ|JCC|JCS|JMP|JNC|JNS|JOC|JOS|JZC|JZS|LDA|LDAH|LDAL|LDB|LDBH|LDBL|LDD|LDI|LDJ|LDS|LMHI|LMLI|MSB|NOP|ORA|ORB|READ|REST|RET|SED|SEI|SHL|SHR|SMHI|SMLI|STA|STAH|STB|STBH|STI|STJ|SUA|SUB|TAB|TABH|TABL|TAD|TAHJ|TAI|TAMH|TAML|TBA|TBAH|TBAL|TBHJ|TBI|TIS|TSB|WRTE|WRTI|XORA|XORB)\b/g;
